...
configure_partial_rollout() {
  # PROVISION_SIZE is the user-facing alias for oversampling batch size.
...
export_train_env() {
  ...
  export SAVE_HF_WEIGHTS
  export SAVE_HF_ONLY_FINAL
